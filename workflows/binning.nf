...
include { BEDTOOLS_INTERSECT as BEDTOOLS_INTERSECT_CCRE } from '../modules/nf-core/bedtools/intersect/main'
include { BEDTOOLS_INTERSECT as BEDTOOLS_INTERSECT_HIST } from '../modules/nf-core/bedtools/intersect/main'
include { BEDTOOLS_INTERSECT as BEDTOOLS_INTERSECT_INTER } from '../modules/nf-core/bedtools/intersect/main'
...
workflow BINNING {
    ...
    BEDTOOLS_INTERSECT(ch_samplesheet, tuple([], []))
